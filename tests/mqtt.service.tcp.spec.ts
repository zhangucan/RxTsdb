...
describe('MqttService using TCP', () => {
  ...
  it('#publish', (done) => {
    mqttService.observe('mqtt-rx/tests/tcp/publish/' + currentUuid).subscribe((result: IMqttMessage) => {
      console.log(result);
      done();
    });
    mqttService.publish('mqtt-rx/tests/tcp/publish/' + currentUuid, 'publish').subscribe(result => {
      console.log(result);
      done();
    });
  });
